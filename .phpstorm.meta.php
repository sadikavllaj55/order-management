...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/sadik/Desktop/order-management/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/sadik/Desktop/order-management/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','order.statuses',
'product.statuses','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'products.destroy','customers.index','customers.store','customers.show','customers.update',
'customers.destroy','orders.index','orders.store','orders.show','orders.update',
'orders.destroy','product-types.index','product-types.store','product-types.show','product-types.update',
'product-types.destroy','storage.local',);
...
'PASSPORT_PASSWORD_CLIENT_ID','PASSPORT_PASSWORD_CLIENT_SECRET','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
